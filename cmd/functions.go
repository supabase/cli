...
var (
	...
	functionsNewCmd = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return new_.Run(cmd.Context(), args[0], useJs, afero.NewOsFs())
		},
	}
...
func init() {
	...
	functionsNewCmd.Flags().BoolVar(&useJs, "use-js", false, "Use JavaScript instead of TypeScript for writing functions.")
