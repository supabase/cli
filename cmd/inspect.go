...
import (
	...
	"github.com/supabase/cli/v2/internal/inspect/bloat"
	"github.com/supabase/cli/v2/internal/inspect/blocking"
	"github.com/supabase/cli/v2/internal/inspect/cache"
	"github.com/supabase/cli/v2/internal/utils"
	"github.com/supabase/cli/v2/internal/utils/flags"

	"github.com/supabase/cli/v2/internal/inspect"
	"github.com/supabase/cli/v2/internal/inspect/calls"
	"github.com/supabase/cli/v2/internal/inspect/index_sizes"
	"github.com/supabase/cli/v2/internal/inspect/index_usage"
	"github.com/supabase/cli/v2/internal/inspect/locks"
	"github.com/supabase/cli/v2/internal/inspect/long_running_queries"
	"github.com/supabase/cli/v2/internal/inspect/outliers"
	"github.com/supabase/cli/v2/internal/inspect/replication_slots"
	"github.com/supabase/cli/v2/internal/inspect/role_configs"
	"github.com/supabase/cli/v2/internal/inspect/role_connections"
	"github.com/supabase/cli/v2/internal/inspect/seq_scans"
	"github.com/supabase/cli/v2/internal/inspect/table_index_sizes"
	"github.com/supabase/cli/v2/internal/inspect/table_record_counts"
	"github.com/supabase/cli/v2/internal/inspect/table_sizes"
	"github.com/supabase/cli/v2/internal/inspect/total_index_size"
	"github.com/supabase/cli/v2/internal/inspect/total_table_sizes"
	"github.com/supabase/cli/v2/internal/inspect/unused_indexes"
	"github.com/supabase/cli/v2/internal/inspect/vacuum_stats"
)
