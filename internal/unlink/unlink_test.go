...
func TestUnlinkCommand(t *testing.T) {
	...
	t.Run("unlink valid project", func(t *testing.T) {
		...
		// Run link
		err := link.Run(context.Background(), project, dbConfig.Password, fsys, conn.Intercept)
		// Check error
		assert.NoError(t, err)
		assert.Empty(t, apitest.ListUnmatchedRequests())
		// Run unlink test
		err = Run(context.Background(), dbConfig.Password, fsys, conn.Intercept)
		// Check error
		assert.NoError(t, err)
		assert.Empty(t, apitest.ListUnmatchedRequests())
	...
	t.Run("throws error on network failure", func(t *testing.T) {
		...
		// Run test
		err := Run(context.Background(), dbConfig.Password, fsys)
		// Check error
	...
	t.Run("ignores error linking services", func(t *testing.T) {
		...
		gock.New(utils.DefaultApiHost).
			...
			ReplyError(errors.New("network error"))
		// Run test
		err := Run(context.Background(), dbConfig.Password, fsys, func(cc *pgx.ConnConfig) {
...
func TestLinkDatabase(t *testing.T) {
	t.Run("throws error on connect failure", func(t *testing.T) {
		defer teardown()
		// Run test
		err := unlinkDatabase(context.Background(), pgconn.Config{})
		// Check error
	...
	t.Run("ignores missing server version", func(t *testing.T) {
		...
		pgtest.MockMigrationHistory(conn)
		// Run test
		err := unlinkDatabase(context.Background(), dbConfig, conn.Intercept)
		// Check error
		assert.NoError(t, err)
		assert.Empty(t, updatedConfig)
	})
