 ...
 */
export declare function getDefaultCliConfig(): CliConfig;
/**
 ...
 */
export declare function setOwnProperty(target: Record<string, unknown>, key: string, value: unknown): void;
/**
 ...
 * well-defined.
 */
export declare function subtractValue(value: unknown, baseline: unknown): unknown;
/**
 ...
 * resolves to.
 */
export declare function subtractCliConfig(config: EffectiveConfig, baseline: EffectiveConfig): SparseCliConfig;
/**
 ...
 */
export declare function omitDefaultValues(config: EffectiveConfig): SparseCliConfig;
