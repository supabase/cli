...
export declare const cliConfigSchemaKey = "$schema";
...
export declare const cliConfigValueSourceAt: (loaded: Pick<LoadedCliConfig, "valueOrigins">, path: ReadonlyArray<string>) => CliConfigValueSource | undefined;
/**
...
export declare function encodeCliConfigToJson(config: CliConfig): string;
export declare function encodeCliConfigToToml(config: CliConfig): string;
/** Shared with `io.ts`'s `saveCliConfig`, which needs the `schemaRef`-carrying variant. */
export declare function encodeCliConfigToJsonDocument(config: CliConfig, schemaRef: string | undefined): string;
/** Shared with `io.ts`'s `saveCliConfig`, which needs the `schemaRef`-carrying variant. */
export declare function encodeCliConfigToTomlDocument(config: CliConfig, schemaRef: string | undefined): string;
