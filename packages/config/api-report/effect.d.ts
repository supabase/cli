 ...
 */
export declare const resolveCliConfigValue: <T>(value: T, cliProjectEnv: Pick<CliProjectEnvironment, "values">, configPath: string) => Effect.Effect<ResolvedCliConfigValue<T>>;
/** See {@link resolveCliConfigValue}'s doc comment for the shadowing and narrowing rationale. */
export declare const resolveCliConfigSubtree: <T>(value: T, cliProjectEnv: Pick<CliProjectEnvironment, "values">, pathPrefix: string) => Effect.Effect<ResolvedCliConfigValue<T>>;
