...
export const rate_limit = Schema.Struct({
  email_sent: Schema.Finite.annotate({
  ...
  sms_sent: Schema.Finite.annotate({
  ...
  anonymous_users: Schema.Finite.annotate({
  ...
  token_refresh: Schema.Finite.annotate({
  ...
  sign_in_sign_ups: Schema.Finite.annotate({
  ...
  token_verifications: Schema.Finite.annotate({
