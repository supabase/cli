...
/** Tagged failures preserve the error identity across lifecycle boundaries. */
export type ServiceEffectError = { readonly _tag: string };

export interface LifecycleHook {
  readonly on: HookTrigger;
  readonly run: (log: HookLog) => Effect.Effect<void, ServiceEffectError>;
  readonly timeoutSeconds?: number;
...
export interface ServiceDef {
  ...
  readonly cleanup?: Effect.Effect<void, ServiceEffectError>;
...
export interface ServiceStartOptions {
  ...
  readonly beforeStart?: (name: string) => Effect.Effect<void, ServiceEffectError>;
