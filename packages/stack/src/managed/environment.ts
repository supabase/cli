...
// oxlint-disable-next-line effecttsgo/node-builtin-import -- Git/workspace identity canonicalization needs platform-native path semantics before Effect filesystem access.
