 ...
 */
export const makeDatabaseSessionFromSqlClient = (client: DatabaseSqlClient): DatabaseSession => {
  const executeWith = (
    sql: string,
  ...
  const transaction: DatabaseTransaction = {
    ...
    setRolePassword: (role, password) =>
      generated("SELECT format('ALTER ROLE %I PASSWORD %L', $1, $2) AS statement", [
        role,
    ...
    setDatabaseSetting: (setting: DatabaseBootstrapSetting) => {
      ...
      return generated(
        "SELECT format('ALTER DATABASE postgres SET %I TO %L', $1, $2) AS statement",
        [setting.name, value],
      );
    },
  };
