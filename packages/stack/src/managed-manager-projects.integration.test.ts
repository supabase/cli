// oxlint-disable effecttsgo/multiple-effect-provide, effecttsgo/node-builtin-import -- Tests intentionally exercise native async, HTTP, timer, and subprocess boundaries.
