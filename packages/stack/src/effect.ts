...
export { deleteManagedStackPersistence, listStacks, stopDaemon } from "./discovery.ts";

// Config resolution
export { defaultManagedStackName, resolveConfig, resolveDaemonConfig } from "./createStack.ts";
