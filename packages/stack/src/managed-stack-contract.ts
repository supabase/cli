...
export type ManagedStackContractRecoveryOperation =
  ...
  | {
      readonly operation: "rebindCheckout";
      readonly checkoutId: string;
      readonly path: string;
    }
  | {
      readonly operation: "adoptCheckout";
      readonly checkoutId: string;
      readonly path: string;
    }
  | {
      readonly operation: "adoptContext";
      readonly contextId: string;
      readonly branch: string;
    }
...
type ManagedStackContractWrite =
  ...
  | {
      readonly target: "git-checkout-id";
      readonly operation: "create" | "update";
      readonly id: string;
    }
  | {
...
export const managedNativePlatformByNodeTarget: Readonly<Record<string, string>> = {
...
export const managedNativePlatformFromNode = (
  os: string,
  architecture: string,
): string | undefined => managedNativePlatformByNodeTarget[`${os}-${architecture}`];
...
const directStackApiProjection = {
...
const additionalIdentityContractFixtures = defineManagedStackContractFixtures([
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Created default stack with a new branch context",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Created workspace/default",
          fields: {
            projectId: "project-a",
            checkoutId: "checkout-a",
            contextId: "context-workspace",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Started workspace/default",
          fields: {
            contextId: "context-workspace",
            stackId: "stack-workspace-default",
            stack: "default",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Started main/default after moving the checkout",
          fields: { checkoutId: "checkout-a", stackId: "stack-main-default", stack: "default" },
        },
  ...
  },
  {
    ...
    expected: {
      ...
      writes: [
        ...
        { target: "git-checkout-id", operation: "create", id: "checkout-clone" },
        {
          target: "git-config",
          operation: "create",
      ...
      output: {
        human: {
          summary: "Created main/default for the fresh clone",
          fields: {
            projectId: "project-clone",
            checkoutId: "checkout-clone",
            contextId: "context-clone-main",
  ...
  {
    id: "identity.recycled-previous-path-rebinds-checkout",
    title: "A moved checkout rebinds its recycled previous path without changing identity",
    area: "identity",
    given: [
      {
        kind: "workspace",
    ...
    expected: {
      ...
      warning: {
        code: "CHECKOUT_REBOUND",
        message: "Checkout checkout-a was rebound from /old/project-a to /new/project-a",
        recovery: ["Continue using the managed checkout at /new/project-a"],
        recoveryOperations: [
          { operation: "rebindCheckout", checkoutId: "checkout-a", path: "/new/project-a" },
        ],
      },
      writes: [
        { target: "registry", operation: "update", id: "checkout-a" },
      ...
      runtimeEffects: [{ operation: "start", stackId: "stack-main-default" }],
      details: {
        recycled_previous_path: true,
        recycled_path_claimed: false,
      },
      output: {
        api: {
          outcome: "reuse",
  ...
  {
    id: "identity.superseded-path-reappearance-blocks-both-claims",
    title: "A superseded path reappearance blocks both checkout claims",
    area: "identity",
    given: [
      {
        kind: "workspace",
    ...
    expected: {
      outcome: "error",
      error: {
        code: "CHECKOUT_PATH_CONFLICT",
        message: "Checkout claims for /old/project-a and /new/project-a are both blocked",
        recovery: ["Inspect both checkout claims before choosing an owner"],
        recoveryOperations: [
          { operation: "adoptCheckout", checkoutId: "checkout-a", path: "/new/project-a" },
        ],
      },
      writes: [],
      runtimeEffects: [],
  ...
  {
    id: "identity.interrupted-folder-to-git-transition-reports-without-starting",
    title: "An interrupted folder-to-Git transition reports without starting a stack",
    area: "identity",
    given: [
      {
        kind: "workspace",
    ...
    expected: {
      outcome: "error",
      error: {
        code: "FOLDER_TO_GIT_INCOMPLETE",
        message: "The folder-to-Git identity transition is incomplete",
        recovery: ["Complete the Git transition, then retry managed start"],
        recoveryOperations: [{ operation: "newCheckout", path: "/work/project-a" }],
      },
      writes: [],
      runtimeEffects: [],
      output: {
        human: {
          summary: "Managed start is blocked by an incomplete folder-to-Git transition",
          fields: { path: "/work/project-a" },
          recovery: ["Complete the Git transition, then retry managed start"],
        },
        json: {
          outcome: "error",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Created feat-copy/default with a new branch context",
          fields: { contextId: "context-copy", stackId: "stack-copy-default", stack: "default" },
        },
        json: {
          outcome: "create",
          branch: "feat-copy",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Started renamed/default with its preserved context",
          fields: { contextId: "context-main", stackId: "stack-main-default", stack: "default" },
        },
        json: {
          outcome: "reuse",
          branch: "renamed",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Created main/default without inheriting the tracked marker",
          fields: {
            projectId: "project-clone",
            checkoutId: "checkout-clone",
            contextId: "context-clone-main",
  ...
  },
  {
    ...
    expected: {
      ...
      writes: [
        ...
        { target: "git-checkout-id", operation: "create", id: "checkout-a" },
        {
          target: "git-config",
          operation: "create",
          id: "context-main",
      ...
      output: {
        human: {
          summary: "Started main/default after converting the folder to Git",
          fields: {
            projectId: "project-a",
            checkoutId: "checkout-a",
            contextId: "context-main",
  ...
  },
  {
    ...
    expected: {
      ...
      writes: [
        ...
        { target: "git-checkout-id", operation: "create", id: "checkout-git" },
        {
          target: "git-config",
          operation: "create",
          id: "context-git-main",
      ...
      output: {
        human: {
          summary: "Created main/default with fresh Git identity",
          fields: {
            projectId: "project-git",
            checkoutId: "checkout-git",
            contextId: "context-git-main",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Cannot choose a folder identity for the Git repository",
...
const additionalPortContractFixtures = defineManagedStackContractFixtures([
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Cannot start default because its sticky port is occupied",
          fields: { code: "STICKY_PORT_OCCUPIED", stackId: "stack-feat-default", port: "55421" },
          recovery: [
            "Stop the process using port 55421",
            "Delete and recreate the stack to allocate new automatic ports",
          ],
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Cannot start while the matching legacy stack is running",
          fields: { code: "LEGACY_SOURCE_RUNNING", port: "54321" },
          recovery: ["Stop the legacy stack, then retry supabase start --experimental"],
        },
        json: {
          outcome: "error",
...
const additionalRuntimeContractFixtures = defineManagedStackContractFixtures([
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Conflicting runtime selections",
          fields: {
            code: "RUNTIME_SELECTION_CONFLICT",
            cliRuntime: "docker",
            configRuntime: "native",
          },
          recovery: ["Remove one runtime override", "Make the CLI and config runtime values agree"],
        },
        json: {
    ...
    expected: {
      ...
      output: {
        human: {
          ...
          fields: { code: "DOCKER_UNAVAILABLE", requestedRuntime: "docker" },
          recovery: ["Start Docker", "Remove --runtime docker to use automatic selection"],
        },
        json: {
          outcome: "error",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Started main/default with its persisted runtime",
          fields: { stackId: "stack-main-default", stack: "default", runtime: "native" },
        },
        json: {
          outcome: "reuse",
          stack_id: "stack-main-default",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "The persisted native runtime is unavailable",
          fields: { code: "PERSISTED_RUNTIME_UNAVAILABLE", stackId: "stack-main-default" },
          recovery: [
            "Restore the native prerequisite",
            "Create a new Docker named stack",
            "Delete and recreate this stack",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Native mode is unsupported on darwin-x64",
          fields: { code: "NATIVE_PLATFORM_UNSUPPORTED", platform: "darwin-x64" },
          recovery: ["Use Docker", "Use darwin-arm64, linux-amd64, or linux-arm64"],
        },
        json: {
          outcome: "error",
...
const additionalLifecycleContractFixtures = defineManagedStackContractFixtures([
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "The legacy stack must be stopped before bootstrap",
          fields: { code: "LEGACY_SOURCE_RUNNING" },
          recovery: ["Stop the legacy stack", "Retry supabase start --experimental"],
        },
        json: {
          outcome: "error",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Started main/default from independent managed state",
          fields: { stackId: "stack-main-default", stack: "default" },
        },
        json: {
          outcome: "reuse",
          stack_id: "stack-main-default",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Created main/default with stable local credentials",
          fields: { stackId: "stack-main-default", stack: "default" },
        },
        json: {
          outcome: "create",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Started main/default with unchanged credentials",
          fields: { stackId: "stack-main-default", stack: "default" },
        },
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Updated credentials and started main/default",
          fields: { stackId: "stack-main-default", stack: "default" },
        },
        json: {
          outcome: "update",
  ...
  },
  {
    ...
    expected: {
      ...
      output: {
        human: {
          summary: "Stack stack-orphan was already deleted",
          fields: { stackId: "stack-orphan" },
        },
        json: {
          outcome: "no-op",
...
export const managedStackContractFixtures = defineManagedStackContractFixtures([
  ...
  },
  {
    ...
    expected: {
      ...
      output: { api: directStackApiProjection },
    },
  },
  {
