...
const canonicalGitDirectory = Effect.fn("Identity.canonicalGitDirectory")(
  (
...
const locateGitDirectory = Effect.fn("Identity.locateGitDirectory")(
  (
    fs: FileSystem.FileSystem,
    path: Path.Path,
...
const resolveBranchContext = Effect.fn("Identity.resolveBranchContext")(
  (
    fs: FileSystem.FileSystem,
    path: Path.Path,
    gitDirectory: string,
...
export const resolveGitBranchContext = Effect.fn("Identity.resolveGitBranchContext")(function* (
  canonicalProjectRoot: string,
) {
