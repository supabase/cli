...
// V1ProjectUpdateSnippetJSONRequestBody defines body for V1ProjectUpdateSnippet for application/json ContentType.
type V1ProjectUpdateSnippetJSONRequestBody = UpsertContentBody
