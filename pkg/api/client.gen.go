...
func NewV1CreateAFunctionRequestWithBody(server string, ref string, params *V1CreateAFunctionParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.ResourceMultiplier != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "resource_multiplier", runtime.ParamLocationQuery, *params.ResourceMultiplier); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
