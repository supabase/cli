...
def lifecycle(
    *, cli: Path, api: Path, implementation: str, runtime: str, mode: str, label: str,
    ...
    if traced:
        ...
        env["SUPABASE_STARTUP_TRACE_FILE"] = str(trace_path)
    else:
        env.pop("SUPABASE_STARTUP_TRACE_FILE", None)
...
def main() -> int:
    ...
    for name in ("DOCKER_CONTEXT", "SUPABASE_PROJECT_ID", "SUPABASE_NETWORK_ID", "SUPABASE_STARTUP_TRACE_FILE", "SUPABASE_STACK_TRACE_FILE"):
