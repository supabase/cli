...
| `db remote changes`                                | `src/commands/db/remote/changes/`                                                                 | inline in `cmd/db.go` over `internal/db/diff` | Same CLI-1964 ruling. `db remote commit` is native `db pull`.                                                                        |
| `gen keys`                                         | `src/commands/gen/keys/`                                                                          | `legacy/keys`                                 | Same ruling; requires `--experimental`.                                                                                              |
| `functions download --legacy-bundle` (hidden flag) | `src/shared/functions/download.ts` `makeGoProxyLegacyBundleArgs`                                  | `internal/functions/download`                 | Legacy Deno bundle extraction (CLI-1963).                                                                                            |
