...
| `branches create`                      | `ported`  | `supabase branches create`                                             | Supports --region, --size, --persistent, --with-data, --notify-url; auto-detects git branch name with interactive confirmation or CI auto-use.         |
