...
Notebook files are read only from inside the project: `supabase/notebooks/` and each
entry are canonicalized and refused when they resolve outside the project root.
