...
import type { PgDeltaExportManifest, PgDeltaSqlFile } from "./pgdelta-engine.service.ts";

const EXPORT_MANIFEST_FILE = ".pgdelta-export.json";

class PgDeltaFilesError extends Data.TaggedError("PgDeltaFilesError")<{
...
const filesError = (message: string) => new PgDeltaFilesError({ message });
