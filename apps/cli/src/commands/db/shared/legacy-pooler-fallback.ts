...
import { legacyIsIPv6ConnectivityError } from "../../../command-internal/legacy-connect-errors.ts";
...
export { legacyEmitPoolerFallbackWarning } from "../../../command-internal/legacy-pooler-fallback.ts";
