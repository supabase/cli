...
import { parseLegacyConnectionString } from "../../../command-internal/legacy-db-config.parse.ts";
...
import { LEGACY_PG_DELTA_CA_BUNDLE } from "../../../command-internal/legacy-pgdelta-ssl.ts";
