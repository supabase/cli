...
import { legacyDropObjectsSql } from "../../../command-internal/legacy-drop-objects.ts";
import { LEGACY_EDGE_RUNTIME_SCRIPT_ERROR_SENTINEL } from "../../../command-internal/legacy-edge-runtime-script.service.ts";
import {
