...
When `[experimental].stack` is on, shadows are registered database services in the project stack.
Each has a unique instance ID, managed SQL endpoint, and owned data under
