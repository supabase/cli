...
import { LEGACY_COMPOSE_PROJECT_LABEL } from "../../../command-internal/db-bootstrap/container-lifecycle.ts";
import { LEGACY_CLI_PROJECT_LABEL } from "../../../command-internal/legacy-docker-ids.ts";
