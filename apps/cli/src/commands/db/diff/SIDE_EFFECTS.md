...
| `~/.supabase/cache/shadow-baseline/stack-shadow-baseline-<key>.tar.<pid>.partial`                          | tar                                                                                   | `[experimental].stack` abandoned-partial sweep — same 5-minute TTL, stack prefix only (legacy `shadow-baseline-*.partial` names are not candidates)                                                                                                                                                                                                                                                                                                                                                                                                              |
