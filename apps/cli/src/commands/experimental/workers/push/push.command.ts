...
export const workersPushCommand = Command.make("push", config).pipe(
  ...
  Command.withExamples([
    {
      command: workersCommandLine("push"),
      description: "Deploy every worker in the project",
    },
    {
      command: workersCommandLine("push api"),
      description: "Deploy a single worker",
    },
    {
      command: workersCommandLine("push api web"),
      description: "Deploy several workers by name",
    },
    {
      command: workersCommandLine("push api --exposure private"),
      description: "Deploy without an internet-facing URL",
    },
    {
      command: workersCommandLine("push api --no-wait"),
