...
export const legacyStackEnvOverrides = (entries: ReadonlyArray<string>) =>
  Effect.gen(function* () {
...
export const legacyStackEnvValues = (
  status: StackStatus,
...
export const legacyEncodeStackEnv = (values: Readonly<Record<string, string>>) =>
  Effect.forEach(
