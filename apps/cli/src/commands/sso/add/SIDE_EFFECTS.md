...
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `0`  | success                                                                                                                                                                                                                                                                                                        |
| `1`  | `SsoInvalidFlagValueError` — a `--type`/`--skip-url-validation`/`--name-id-format` occurrence pflag's `Value.Set` would reject (enum membership / `strconv.ParseBool`; fails before every validation; no request)                                                                                              |
...
| `1`  | `SsoFlagNeedsArgumentError` — a bare value-taking flag is the final argv token (pflag `ValueRequiredError`, fails before every validation; no request)                                                                                                                                                         |
| `1`  | `ProfileLoadError` — the pflag/viper-effective `--profile`/`SUPABASE_PROFILE` cannot be loaded the way the old Go CLI's profile loader loaded it (before the workdir change; beats the workdir, required-flag, and mutex checks; no request)                                                                   |
| `1`  | `PflagWorkdirError` — the pflag/viper-effective `--workdir`/`SUPABASE_WORKDIR` is not an existing directory (the old Go CLI's workdir-change step; beats the required-flag and mutex checks; no request)                                                                                                       |
| `1`  | `SsoAddRequiredFlagError` — pflag consumed the `--type`/`-t` token as another flag's value (cobra `ValidateRequiredFlags`)                                                                                                                                                                                     |
| `1`  | `SsoMutexFlagError` — `--metadata-file` and `--metadata-url` both set                                                                                                                                                                                                                                          |
| `1`  | `SsoAddMetadataFileError` — metadata file unreadable, non-UTF-8, or metadata URL invalid/unreachable/non-UTF-8                                                                                                                                                                                                 |
| `1`  | `SsoAddAttributeMappingFileError` — JSON file unreadable or malformed                                                                                                                                                                                                                                          |
| `1`  | `SsoAddSamlDisabledError` — 404 from POST                                                                                                                                                                                                                                                                      |
| `1`  | `SsoAddUnexpectedStatusError` — other non-2xx                                                                                                                                                                                                                                                                  |
| `1`  | `SsoAddNetworkError` — transport-level failure                                                                                                                                                                                                                                                                 |
