...
import { translateFunctionsDevStackConfig } from "../../../config/functions-stack-config.ts";
...
export const resolveFunctionsBundle = Effect.fnUntraced(function* (
  ...
  return yield* translateFunctionsDevStackConfig({
    loadedProjectConfig: loadedConfig,
    projectEnvironment,
    projectRoot: projectHome.projectRoot,
    configDir: projectHome.supabaseDir,
    envFilePath,
