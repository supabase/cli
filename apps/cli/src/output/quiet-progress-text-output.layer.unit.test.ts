...
import { quietProgressTextOutputLayer } from "./quiet-progress-text-output.layer.ts";
...
describe("quietProgressTextOutputLayer", () => {
  const layer = quietProgressTextOutputLayer.pipe(
