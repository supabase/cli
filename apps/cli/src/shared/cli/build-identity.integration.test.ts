// oxlint-disable effecttsgo/async-function -- subprocess/filesystem integration tests use a Promise boundary.
// oxlint-disable effecttsgo/node-builtin-import -- these tests exercise the real Bun/Node subprocess boundary.
// oxlint-disable effecttsgo/global-date -- filesystem metadata fixtures intentionally use explicit dates.
