 ...
 * own directory (reusing `spawn`/`collectText` exactly as
 * `container-cli.ts`'s `containerCliExitCodeAndStdout` does) —
 ...
 */
export function configFileHasUncommittedChanges(
  filePath: string,
