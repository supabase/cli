...
import { downloadFunctions, makeGoProxyLegacyBundleArgs } from "../shared/functions/download.ts";
import { resolveEdgeRuntimeVersionPin } from "../shared/functions/functions.shared.ts";
import { GoProxy } from "./go-proxy.service.ts";
import { aqua, bold, yellow } from "./colors.ts";
import { functionsGoConfigCompat } from "./functions-go-config.ts";
import { CommandPlatformApi } from "../auth/command-platform-api.service.ts";
import { CommandSettings } from "../config/command-settings.service.ts";
import { ProjectRefResolver } from "../config/project-ref.service.ts";
import { LinkedProjectCache } from "../telemetry/linked-project-cache.service.ts";
import { TelemetryState } from "../telemetry/telemetry-state.service.ts";
import type { FunctionsDownloadFlags } from "../commands/functions/download/download.command.ts";

export const downloadProjectFunctions = Effect.fnUntraced(function* (
