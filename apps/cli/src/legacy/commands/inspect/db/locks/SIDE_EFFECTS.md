...
Runs the locks query directly against the linked (or local) Postgres database and
prints a table showing queries that have taken out exclusive locks on a relation.
