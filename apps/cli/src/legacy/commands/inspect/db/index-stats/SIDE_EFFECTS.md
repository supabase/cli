...
Prints a table showing combined index size, usage percent, scan counts, and unused status.
Supersedes `cache-hit`, `index-usage`, `total-index-size`, `index-sizes`, `unused-indexes`, and `seq-scans`.
