...
Prints a table showing combined table size, index size, and estimated row count.
Supersedes `table-sizes`, `table-index-sizes`, `total-table-sizes`, and `table-record-counts`.
