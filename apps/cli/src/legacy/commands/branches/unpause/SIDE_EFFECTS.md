...
| ------ | ---------------------------------- | ------------ | ------------ | ---------------------- |
| `POST` | `/v1/branches/{branch_id}/unpause` | Bearer token | none         | none                   |
...
| `1`  | API error — non-2xx response from `/v1/branches/{branch_id}/unpause` |
...
- The Go CLI internally resolves a branch name to a project ref by calling `/v1/projects/{ref}/branches/{name}` first, then POSTs to `/v1/projects/{branch_project_ref}/restore`.
