...
| Auth email template HTML (`content_path`)      | HTML                      | when `auth.enabled`; path resolution in Notes below                                                                                                                                |
