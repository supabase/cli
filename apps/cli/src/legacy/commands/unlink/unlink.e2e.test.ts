// oxlint-disable effecttsgo/async-function, effecttsgo/node-builtin-import -- legacy e2e exercises the subprocess and temporary filesystem boundary directly.
