...
| `<workdir>/supabase/.temp/pgdelta/shadow-baseline-<key>.tar`                              | tar        | warm shadow-cache hit (migration-style pull) — snapshot streamed into the fresh shadow container before it starts                        |
