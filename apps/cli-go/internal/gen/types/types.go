...
func Run(ctx context.Context, projectId string, dbConfig pgconn.Config, lang string, schemas []string, postgrestV9Compat bool, swiftAccessControl string, queryTimeout time.Duration, directDbURL bool, fsys afero.Fs, options ...func(*pgx.ConnConfig)) error {
	...
	if utils.IsLocalDatabase(dbConfig) && !directDbURL {
